...
def evaluate_single_model(data, model_type, name=None, file_scores=None, file_scores_lables=None, overwrite_tables=True, **params):
    """ Evaluating a single model. Parameters for models are given in params.
    Results can be saved intermediately in a file.
    Parameters:
        data (dict): dictionary produced by preprocess_dataset containing all necessary information
        model_type (str): Can be one of the following:
    ...
    print("Starting to evalute Model {}...".format(model_type))

    if model_type == "baseline" or model_type == "kmeans" or model_type == "gmm" or model_type == "bmm" or model_type == "rf" or model_type == "rf_bal" or model_type == "svm" or model_type == "knn" or model_type == "easy_ensemble" or model_type == "self_trainer" or model_type == "label_spreading" or model_type == "lstm" or model_type == "blstm" or model_type == "enc_dec":
        print("Evaluating {} Model ...\n".format(name))
        model = get_single_model(model_type=model_type, data=data,
                                 **BEST_PARAMS[model_type])
        # usual case
